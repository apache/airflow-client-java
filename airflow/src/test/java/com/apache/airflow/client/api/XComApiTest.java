...
public class XComApiTest {
     ...
     */
    @Test
    public void getXcomEntriesTest() throws ApiException {
        String dagId = null;
        String dagRunId = null;
        String taskId = null;
        Integer limit = null;
        Integer offset = null;
        XComCollection response = api.getXcomEntries(dagId, dagRunId, taskId, limit, offset);
    ...
    public void getXcomEntryTest() throws ApiException {
        ...
        String taskId = null;
        String xcomKey = null;
        XCom response = api.getXcomEntry(dagId, dagRunId, taskId, xcomKey);
