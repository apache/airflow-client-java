...
import com.apache.airflow.client.model.ProviderCollection;
...
public class ProviderApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> List of providers. </td><td>  -  </td></tr>
    ...
    private okhttp3.Call getProvidersValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProvidersCall(_callback);
        return localVarCall;
     ...
     */
    public ProviderCollection getProviders() throws ApiException {
        ApiResponse<ProviderCollection> localVarResp = getProvidersWithHttpInfo();
     ...
     */
    public ApiResponse<ProviderCollection> getProvidersWithHttpInfo() throws ApiException {
     ...
     */
    public okhttp3.Call getProvidersAsync(final ApiCallback<ProviderCollection> _callback) throws ApiException {
