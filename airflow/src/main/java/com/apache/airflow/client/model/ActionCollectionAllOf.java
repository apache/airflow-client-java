...
public class ActionCollectionAllOf {
  public static final String SERIALIZED_NAME_ACTIONS = "actions";
  @SerializedName(SERIALIZED_NAME_ACTIONS)
  private List<Action> actions = null;


  public ActionCollectionAllOf actions(List<Action> actions) {
    
    this.actions = actions;
    return this;
  }

  public ActionCollectionAllOf addActionsItem(Action actionsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ActionCollectionAllOf actionCollectionAllOf = (ActionCollectionAllOf) o;
    return Objects.equals(this.actions, actionCollectionAllOf.actions);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionCollectionAllOf {\n");
