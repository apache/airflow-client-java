...
public class DAG {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the DAG is currently seen by the scheduler(s).")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dagId, rootDagId, isPaused, isActive, isSubdag, fileloc, fileToken, owners, description, scheduleInterval, tags);
  }
