...
public class RoleCollectionAllOf {
  public static final String SERIALIZED_NAME_ROLES = "roles";
  @SerializedName(SERIALIZED_NAME_ROLES)
  private List<Role> roles = null;


  public RoleCollectionAllOf roles(List<Role> roles) {
    
    this.roles = roles;
    return this;
  }

  public RoleCollectionAllOf addRolesItem(Role rolesItem) {
    if (this.roles == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RoleCollectionAllOf roleCollectionAllOf = (RoleCollectionAllOf) o;
    return Objects.equals(this.roles, roleCollectionAllOf.roles);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoleCollectionAllOf {\n");
