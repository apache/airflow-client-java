...
import com.apache.airflow.client.model.User;
import com.apache.airflow.client.model.UserCollection;
import com.apache.airflow.client.model.UserCollectionItem;
...
public class UserApi {
     ...
     */
    public okhttp3.Call patchUserCall(String username, User user, List<String> updateMask, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchUserValidateBeforeCall(String username, User user, List<String> updateMask, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'username' is set
        if (username == null) {
            throw new ApiException("Missing the required parameter 'username' when calling patchUser(Async)");
        }
        ...
        okhttp3.Call localVarCall = patchUserCall(username, user, updateMask, _callback);
        return localVarCall;
     ...
     */
    public Role patchUser(String username, User user, List<String> updateMask) throws ApiException {
        ApiResponse<Role> localVarResp = patchUserWithHttpInfo(username, user, updateMask);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Role> patchUserWithHttpInfo(String username, User user, List<String> updateMask) throws ApiException {
        okhttp3.Call localVarCall = patchUserValidateBeforeCall(username, user, updateMask, null);
     ...
     */
    public okhttp3.Call patchUserAsync(String username, User user, List<String> updateMask, final ApiCallback<Role> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchUserValidateBeforeCall(username, user, updateMask, _callback);
        Type localVarReturnType = new TypeToken<Role>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call postUserCall(User user, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = user;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postUserValidateBeforeCall(User user, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'user' is set
        if (user == null) {
            throw new ApiException("Missing the required parameter 'user' when calling postUser(Async)");
        }
        

        okhttp3.Call localVarCall = postUserCall(user, _callback);
        return localVarCall;
    ...
    public User postUser(User user) throws ApiException {
        ApiResponse<User> localVarResp = postUserWithHttpInfo(user);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<User> postUserWithHttpInfo(User user) throws ApiException {
        okhttp3.Call localVarCall = postUserValidateBeforeCall(user, null);
     ...
     */
    public okhttp3.Call postUserAsync(User user, final ApiCallback<User> _callback) throws ApiException {

        okhttp3.Call localVarCall = postUserValidateBeforeCall(user, _callback);
        Type localVarReturnType = new TypeToken<User>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
