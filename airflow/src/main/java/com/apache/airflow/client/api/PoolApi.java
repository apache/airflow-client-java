...
import com.apache.airflow.client.model.PoolCollection;
...
public class PoolApi {
     ...
     */
    public okhttp3.Call getPoolsCall(Integer limit, Integer offset, String orderBy, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPoolsValidateBeforeCall(Integer limit, Integer offset, String orderBy, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getPoolsCall(limit, offset, orderBy, _callback);
        return localVarCall;
    ...
    public PoolCollection getPools(Integer limit, Integer offset, String orderBy) throws ApiException {
        ApiResponse<PoolCollection> localVarResp = getPoolsWithHttpInfo(limit, offset, orderBy);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<PoolCollection> getPoolsWithHttpInfo(Integer limit, Integer offset, String orderBy) throws ApiException {
        okhttp3.Call localVarCall = getPoolsValidateBeforeCall(limit, offset, orderBy, null);
     ...
     */
    public okhttp3.Call getPoolsAsync(Integer limit, Integer offset, String orderBy, final ApiCallback<PoolCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPoolsValidateBeforeCall(limit, offset, orderBy, _callback);
        Type localVarReturnType = new TypeToken<PoolCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call patchPoolCall(String poolName, Pool pool, List<String> updateMask, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchPoolValidateBeforeCall(String poolName, Pool pool, List<String> updateMask, final ApiCallback _callback) throws ApiException {
        ...
        if (pool == null) {
            throw new ApiException("Missing the required parameter 'pool' when calling patchPool(Async)");
        }
        

        okhttp3.Call localVarCall = patchPoolCall(poolName, pool, updateMask, _callback);
        return localVarCall;
    ...
    public Pool patchPool(String poolName, Pool pool, List<String> updateMask) throws ApiException {
        ApiResponse<Pool> localVarResp = patchPoolWithHttpInfo(poolName, pool, updateMask);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Pool> patchPoolWithHttpInfo(String poolName, Pool pool, List<String> updateMask) throws ApiException {
        okhttp3.Call localVarCall = patchPoolValidateBeforeCall(poolName, pool, updateMask, null);
        Type localVarReturnType = new TypeToken<Pool>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call patchPoolAsync(String poolName, Pool pool, List<String> updateMask, final ApiCallback<Pool> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchPoolValidateBeforeCall(poolName, pool, updateMask, _callback);
        Type localVarReturnType = new TypeToken<Pool>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call postPoolCall(Pool pool, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = pool;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postPoolValidateBeforeCall(Pool pool, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'pool' is set
        if (pool == null) {
            throw new ApiException("Missing the required parameter 'pool' when calling postPool(Async)");
        }
        

        okhttp3.Call localVarCall = postPoolCall(pool, _callback);
        return localVarCall;
    ...
    public Pool postPool(Pool pool) throws ApiException {
        ApiResponse<Pool> localVarResp = postPoolWithHttpInfo(pool);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Pool> postPoolWithHttpInfo(Pool pool) throws ApiException {
        okhttp3.Call localVarCall = postPoolValidateBeforeCall(pool, null);
        Type localVarReturnType = new TypeToken<Pool>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call postPoolAsync(Pool pool, final ApiCallback<Pool> _callback) throws ApiException {

        okhttp3.Call localVarCall = postPoolValidateBeforeCall(pool, _callback);
        Type localVarReturnType = new TypeToken<Pool>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
