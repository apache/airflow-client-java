...
public class PoolCollectionAllOf {
  public static final String SERIALIZED_NAME_POOLS = "pools";
  @SerializedName(SERIALIZED_NAME_POOLS)
  private List<Pool> pools = null;


  public PoolCollectionAllOf pools(List<Pool> pools) {
    
    this.pools = pools;
    return this;
  }

  public PoolCollectionAllOf addPoolsItem(Pool poolsItem) {
    if (this.pools == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PoolCollectionAllOf poolCollectionAllOf = (PoolCollectionAllOf) o;
    return Objects.equals(this.pools, poolCollectionAllOf.pools);
  }
  ...
  public String toString() {
    ...
    sb.append("class PoolCollectionAllOf {\n");
