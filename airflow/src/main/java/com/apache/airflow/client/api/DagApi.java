...
public class DagApi {
     ...
     * @param onlyActive Only return active DAGs. (optional, default to true)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getDagsCall(Integer limit, Integer offset, String orderBy, Boolean onlyActive, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDagsValidateBeforeCall(Integer limit, Integer offset, String orderBy, Boolean onlyActive, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getDagsCall(limit, offset, orderBy, onlyActive, _callback);
        return localVarCall;
     ...
     */
    public DAGCollection getDags(Integer limit, Integer offset, String orderBy, Boolean onlyActive) throws ApiException {
        ApiResponse<DAGCollection> localVarResp = getDagsWithHttpInfo(limit, offset, orderBy, onlyActive);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DAGCollection> getDagsWithHttpInfo(Integer limit, Integer offset, String orderBy, Boolean onlyActive) throws ApiException {
        okhttp3.Call localVarCall = getDagsValidateBeforeCall(limit, offset, orderBy, onlyActive, null);
     ...
     */
    public okhttp3.Call getDagsAsync(Integer limit, Integer offset, String orderBy, Boolean onlyActive, final ApiCallback<DAGCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDagsValidateBeforeCall(limit, offset, orderBy, onlyActive, _callback);
        Type localVarReturnType = new TypeToken<DAGCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
