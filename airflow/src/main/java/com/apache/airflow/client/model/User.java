...
import com.apache.airflow.client.model.UserAllOf;
 ...
 */
@ApiModel(description = "A user object with sensitive data")
...
public class User {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The user lastname")
  ...
  **/
  ...
  public User roles(List<UserCollectionItemRoles> roles) {
    
    this.roles = roles;
    return this;
  }

  public User addRolesItem(UserCollectionItemRoles rolesItem) {
    if (this.roles == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.firstName, user.firstName) &&
        ...
        Objects.equals(this.changedOn, user.changedOn) &&
        Objects.equals(this.password, user.password);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firstName, lastName, username, email, active, lastLogin, loginCount, failedLoginCount, roles, createdOn, changedOn, password);
  }
