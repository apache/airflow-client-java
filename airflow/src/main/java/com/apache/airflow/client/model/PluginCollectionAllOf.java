...
public class PluginCollectionAllOf {
  ...
  public PluginCollectionAllOf plugins(List<PluginCollectionItem> plugins) {
    
    this.plugins = plugins;
    return this;
  }

  public PluginCollectionAllOf addPluginsItem(PluginCollectionItem pluginsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PluginCollectionAllOf pluginCollectionAllOf = (PluginCollectionAllOf) o;
    return Objects.equals(this.plugins, pluginCollectionAllOf.plugins);
  }
  ...
  public String toString() {
    ...
    sb.append("class PluginCollectionAllOf {\n");
