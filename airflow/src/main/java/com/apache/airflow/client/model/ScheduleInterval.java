...
import com.apache.airflow.client.model.CronExpression;
import com.apache.airflow.client.model.RelativeDelta;
 ...
 */
@ApiModel(description = "Schedule interval. Defines how often DAG runs, this object gets added to your latest task instance's execution_date to figure out the next schedule. ")
...
public class ScheduleInterval {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, days, seconds, microseconds, years, months, leapdays, hours, minutes, year, month, day, hour, minute, second, microsecond, value);
  }
