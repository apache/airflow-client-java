...
public class ListDagRunsForm {
  ...
  **/
  ...
  @ApiModelProperty(value = "The name of the field to order the results by. Prefix a field name with `-` to reverse the sort order. ")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(orderBy, pageOffset, pageLimit, dagIds, executionDateGte, executionDateLte, startDateGte, startDateLte, endDateGte, endDateLte);
  }
