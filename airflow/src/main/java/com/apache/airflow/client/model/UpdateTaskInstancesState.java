...
public class UpdateTaskInstancesState {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The execution date.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dryRun, taskId, executionDate, includeUpstream, includeDownstream, includeFuture, includePast, newState);
  }
