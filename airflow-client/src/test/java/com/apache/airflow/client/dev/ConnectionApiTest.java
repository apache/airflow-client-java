...
package com.apache.airflow.client.dev;
...
public class ConnectionApiTest {
    ...
    public void patchConnectionTest() throws ApiException {
        ...
        c.setPort(90);
        Connection response = api.patchConnection(connectionId, c, null);
        assertEquals(90, (Object)api.getConnection(connectionId).getPort());
        api.deleteConnection(connectionId);
    }
