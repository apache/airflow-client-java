...
public class DagApiTest {
    ...
    public void getDagsTest() throws ApiException {
        ...
        DAGCollection response = api.getDags(limit, offset, orderBy, onlyActive);
    ...
    public void postClearTaskInstancesTest() throws ApiException {
        ...
        TaskInstanceReferenceCollection response = api.postClearTaskInstances(dagId, clearTaskInstance);
