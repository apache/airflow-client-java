...
public class UserApiTest {
    ...
    public void getUserTest() throws ApiException {
        String username = null;
        UserCollectionItem response = api.getUser(username);
    ...
    public void getUsersTest() throws ApiException {
        ...
        Integer offset = null;
        String orderBy = null;
        UserCollection response = api.getUsers(limit, offset, orderBy);
    ...
    public void patchUserTest() throws ApiException {
        ...
        Role response = api.patchUser(username, user, updateMask);
    ...
    public void postUserTest() throws ApiException {
        User user = null;
        User response = api.postUser(user);
