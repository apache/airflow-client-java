...
import com.apache.airflow.client.model.PluginCollection;
...
public class PluginApi {
     ...
     */
    public okhttp3.Call getPluginsCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getPluginsValidateBeforeCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getPluginsCall(limit, offset, _callback);
        return localVarCall;
     ...
     */
    public PluginCollection getPlugins(Integer limit, Integer offset) throws ApiException {
        ApiResponse<PluginCollection> localVarResp = getPluginsWithHttpInfo(limit, offset);
     ...
     * @param limit The numbers of items to return. (optional, default to 100)
     * @param offset The number of items to skip before starting to collect the result set. (optional)
     * @return ApiResponse&lt;PluginCollection&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PluginCollection> getPluginsWithHttpInfo(Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = getPluginsValidateBeforeCall(limit, offset, null);
        Type localVarReturnType = new TypeToken<PluginCollection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a list of loaded plugins (asynchronously)
     * 
     * @param limit The numbers of items to return. (optional, default to 100)
     * @param offset The number of items to skip before starting to collect the result set. (optional)
     ...
     */
    public okhttp3.Call getPluginsAsync(Integer limit, Integer offset, final ApiCallback<PluginCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPluginsValidateBeforeCall(limit, offset, _callback);
        Type localVarReturnType = new TypeToken<PluginCollection>(){}.getType();
