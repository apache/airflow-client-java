...
import com.apache.airflow.client.model.DAGRun;
import com.apache.airflow.client.model.DAGRunCollection;
import com.apache.airflow.client.model.Error;
import com.apache.airflow.client.model.ListDagRunsForm;
import java.time.OffsetDateTime;
import com.apache.airflow.client.model.UpdateDagRunState;
...
public class DagRunApi {
    ...
    private okhttp3.Call getDagRunsValidateBeforeCall(String dagId, Integer limit, Integer offset, OffsetDateTime executionDateGte, OffsetDateTime executionDateLte, OffsetDateTime startDateGte, OffsetDateTime startDateLte, OffsetDateTime endDateGte, OffsetDateTime endDateLte, List<String> state, String orderBy, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getDagRunsCall(dagId, limit, offset, executionDateGte, executionDateLte, startDateGte, startDateLte, endDateGte, endDateLte, state, orderBy, _callback);
        return localVarCall;
    ...
    public DAGRunCollection getDagRuns(String dagId, Integer limit, Integer offset, OffsetDateTime executionDateGte, OffsetDateTime executionDateLte, OffsetDateTime startDateGte, OffsetDateTime startDateLte, OffsetDateTime endDateGte, OffsetDateTime endDateLte, List<String> state, String orderBy) throws ApiException {
        ApiResponse<DAGRunCollection> localVarResp = getDagRunsWithHttpInfo(dagId, limit, offset, executionDateGte, executionDateLte, startDateGte, startDateLte, endDateGte, endDateLte, state, orderBy);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<DAGRunCollection> getDagRunsWithHttpInfo(String dagId, Integer limit, Integer offset, OffsetDateTime executionDateGte, OffsetDateTime executionDateLte, OffsetDateTime startDateGte, OffsetDateTime startDateLte, OffsetDateTime endDateGte, OffsetDateTime endDateLte, List<String> state, String orderBy) throws ApiException {
        okhttp3.Call localVarCall = getDagRunsValidateBeforeCall(dagId, limit, offset, executionDateGte, executionDateLte, startDateGte, startDateLte, endDateGte, endDateLte, state, orderBy, null);
     ...
     */
    public okhttp3.Call getDagRunsAsync(String dagId, Integer limit, Integer offset, OffsetDateTime executionDateGte, OffsetDateTime executionDateLte, OffsetDateTime startDateGte, OffsetDateTime startDateLte, OffsetDateTime endDateGte, OffsetDateTime endDateLte, List<String> state, String orderBy, final ApiCallback<DAGRunCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDagRunsValidateBeforeCall(dagId, limit, offset, executionDateGte, executionDateLte, startDateGte, startDateLte, endDateGte, endDateLte, state, orderBy, _callback);
        Type localVarReturnType = new TypeToken<DAGRunCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call updateDagRunStateCall(String dagId, String dagRunId, UpdateDagRunState updateDagRunState, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateDagRunStateValidateBeforeCall(String dagId, String dagRunId, UpdateDagRunState updateDagRunState, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateDagRunStateCall(dagId, dagRunId, updateDagRunState, _callback);
        return localVarCall;
     ...
     */
    public DAGRun updateDagRunState(String dagId, String dagRunId, UpdateDagRunState updateDagRunState) throws ApiException {
     ...
     */
    public ApiResponse<DAGRun> updateDagRunStateWithHttpInfo(String dagId, String dagRunId, UpdateDagRunState updateDagRunState) throws ApiException {
     ...
     */
    public okhttp3.Call updateDagRunStateAsync(String dagId, String dagRunId, UpdateDagRunState updateDagRunState, final ApiCallback<DAGRun> _callback) throws ApiException {
