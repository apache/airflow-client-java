...
import com.apache.airflow.client.model.ActionCollection;
...
public class PermissionApi {
     ...
     */
    public okhttp3.Call getPermissionsCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getPermissionsValidateBeforeCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getPermissionsCall(limit, offset, _callback);
        return localVarCall;
     ...
     */
    public ActionCollection getPermissions(Integer limit, Integer offset) throws ApiException {
        ApiResponse<ActionCollection> localVarResp = getPermissionsWithHttpInfo(limit, offset);
     ...
     */
    public ApiResponse<ActionCollection> getPermissionsWithHttpInfo(Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = getPermissionsValidateBeforeCall(limit, offset, null);
     ...
     */
    public okhttp3.Call getPermissionsAsync(Integer limit, Integer offset, final ApiCallback<ActionCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPermissionsValidateBeforeCall(limit, offset, _callback);
        Type localVarReturnType = new TypeToken<ActionCollection>(){}.getType();
