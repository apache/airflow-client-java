...
import com.apache.airflow.client.model.XCom;
import com.apache.airflow.client.model.XComCollection;
...
public class XComApi {
    ...
    private okhttp3.Call getXcomEntriesValidateBeforeCall(String dagId, String dagRunId, String taskId, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getXcomEntriesCall(dagId, dagRunId, taskId, limit, offset, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call getXcomEntryCall(String dagId, String dagRunId, String taskId, String xcomKey, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getXcomEntryValidateBeforeCall(String dagId, String dagRunId, String taskId, String xcomKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getXcomEntryCall(dagId, dagRunId, taskId, xcomKey, _callback);
        return localVarCall;
    ...
    public XCom getXcomEntry(String dagId, String dagRunId, String taskId, String xcomKey) throws ApiException {
        ApiResponse<XCom> localVarResp = getXcomEntryWithHttpInfo(dagId, dagRunId, taskId, xcomKey);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<XCom> getXcomEntryWithHttpInfo(String dagId, String dagRunId, String taskId, String xcomKey) throws ApiException {
        okhttp3.Call localVarCall = getXcomEntryValidateBeforeCall(dagId, dagRunId, taskId, xcomKey, null);
     ...
     */
    public okhttp3.Call getXcomEntryAsync(String dagId, String dagRunId, String taskId, String xcomKey, final ApiCallback<XCom> _callback) throws ApiException {

        okhttp3.Call localVarCall = getXcomEntryValidateBeforeCall(dagId, dagRunId, taskId, xcomKey, _callback);
        Type localVarReturnType = new TypeToken<XCom>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
