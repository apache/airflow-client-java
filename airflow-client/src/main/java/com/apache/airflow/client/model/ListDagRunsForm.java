...
public class ListDagRunsForm {
  ...
  **/
  ...
  @ApiModelProperty(value = "The name of the field to order the results by. Prefix a field name with `-` to reverse the sort order.  *New in version 2.1.0* ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Return objects with specific states. The value can be repeated to retrieve multiple matching values (OR condition).")
