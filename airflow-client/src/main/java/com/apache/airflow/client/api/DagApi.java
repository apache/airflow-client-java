...
import com.apache.airflow.client.model.ClearTaskInstance;
import com.apache.airflow.client.model.DAG;
import com.apache.airflow.client.model.DAGCollection;
import com.apache.airflow.client.model.DAGDetail;
import com.apache.airflow.client.model.Error;
import com.apache.airflow.client.model.InlineResponse2001;
import com.apache.airflow.client.model.Task;
import com.apache.airflow.client.model.TaskCollection;
import com.apache.airflow.client.model.TaskInstanceReferenceCollection;
import com.apache.airflow.client.model.UpdateTaskInstancesState;
...
public class DagApi {
     ...
     */
    public okhttp3.Call deleteDagCall(String dagId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteDagValidateBeforeCall(String dagId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteDagCall(dagId, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call deleteDagAsync(String dagId, final ApiCallback<Void> _callback) throws ApiException {
     ...
     * @param onlyActive Only return active DAGs.  *New in version 2.1.1*  (optional, default to true)
     * @param dagIdPattern If set, only return DAGs with dag_ids matching this pattern.  *New in version 2.3.0*  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getDagsCall(Integer limit, Integer offset, String orderBy, List<String> tags, Boolean onlyActive, String dagIdPattern, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDagsValidateBeforeCall(Integer limit, Integer offset, String orderBy, List<String> tags, Boolean onlyActive, String dagIdPattern, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getDagsCall(limit, offset, orderBy, tags, onlyActive, dagIdPattern, _callback);
        return localVarCall;
    ...
    public DAGCollection getDags(Integer limit, Integer offset, String orderBy, List<String> tags, Boolean onlyActive, String dagIdPattern) throws ApiException {
        ApiResponse<DAGCollection> localVarResp = getDagsWithHttpInfo(limit, offset, orderBy, tags, onlyActive, dagIdPattern);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<DAGCollection> getDagsWithHttpInfo(Integer limit, Integer offset, String orderBy, List<String> tags, Boolean onlyActive, String dagIdPattern) throws ApiException {
        okhttp3.Call localVarCall = getDagsValidateBeforeCall(limit, offset, orderBy, tags, onlyActive, dagIdPattern, null);
     ...
     */
    public okhttp3.Call getDagsAsync(Integer limit, Integer offset, String orderBy, List<String> tags, Boolean onlyActive, String dagIdPattern, final ApiCallback<DAGCollection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDagsValidateBeforeCall(limit, offset, orderBy, tags, onlyActive, dagIdPattern, _callback);
        Type localVarReturnType = new TypeToken<DAGCollection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
