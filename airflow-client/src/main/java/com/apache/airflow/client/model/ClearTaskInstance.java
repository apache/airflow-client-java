...
public class ClearTaskInstance {
  ...
  **/
  ...
  public ClearTaskInstance taskIds(List<String> taskIds) {
    
    this.taskIds = taskIds;
    return this;
  }

  public ClearTaskInstance addTaskIdsItem(String taskIdsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of task ids to clear.  *New in version 2.1.0* ")
  ...
  **/
  ...
  public ClearTaskInstance onlyFailed(Boolean onlyFailed) {
  ...
  **/
  ...
  public ClearTaskInstance onlyRunning(Boolean onlyRunning) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dryRun, clearTaskInstance.dryRun) &&
        Objects.equals(this.taskIds, clearTaskInstance.taskIds) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dryRun, taskIds, startDate, endDate, onlyFailed, onlyRunning, includeSubdags, includeParentdag, resetDagRuns);
  }
