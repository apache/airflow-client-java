...
import com.apache.airflow.client.model.ActionResource;
 ...
 */
@ApiModel(description = "a role item.  *New in version 2.1.0* ")
...
public class Role {
  ...
  private List<ActionResource> actions = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "The name of the role  *Changed in version 2.3.0*&#58; A minimum character length requirement ('minLength') is added. ")
  ...
  public Role actions(List<ActionResource> actions) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, role.name) &&
        Objects.equals(this.actions, role.actions);
  }
