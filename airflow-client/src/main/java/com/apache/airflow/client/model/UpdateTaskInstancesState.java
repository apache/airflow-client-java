...
public class UpdateTaskInstancesState {
  ...
  **/
  ...
  @ApiModelProperty(value = "If set, don't actually run this operation. The response will contain a list of task instances planned to be affected, but won't be modified in any way. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The execution date. Either set this or dag_run_id but not both.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The task instance's DAG run ID. Either set this or execution_date but not both.  *New in version 2.3.0* ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If set to true, upstream tasks are also affected.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If set to true, downstream tasks are also affected.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If set to True, also tasks from future DAG Runs are affected.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If set to True, also tasks from past DAG Runs are affected.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Expected new state.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dryRun, updateTaskInstancesState.dryRun) &&
        ...
        Objects.equals(this.dagRunId, updateTaskInstancesState.dagRunId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dryRun, taskId, executionDate, dagRunId, includeUpstream, includeDownstream, includeFuture, includePast, newState);
  }
