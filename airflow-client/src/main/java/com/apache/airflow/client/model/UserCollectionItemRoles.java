...
public class UserCollectionItemRoles {
  ...
  public UserCollectionItemRoles name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserCollectionItemRoles userCollectionItemRoles = (UserCollectionItemRoles) o;
    return Objects.equals(this.name, userCollectionItemRoles.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserCollectionItemRoles {\n");
