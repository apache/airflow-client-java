 ...
 */
@ApiModel(description = "The provider  *New in version 2.1.0* ")
...
public class Provider {
  ...
  **/
  ...
  @ApiModelProperty(value = "The package name of the provider.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The description of the provider.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The version of the provider.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.packageName, provider.packageName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(packageName, description, version);
  }
