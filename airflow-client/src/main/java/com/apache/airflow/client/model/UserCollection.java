...
import com.apache.airflow.client.model.UserCollectionAllOf;
 ...
 */
@ApiModel(description = "Collection of users.  *New in version 2.1.0* ")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class UserCollection {
  public static final String SERIALIZED_NAME_USERS = "users";
  @SerializedName(SERIALIZED_NAME_USERS)
  private List<UserCollectionItem> users = null;
  ...
  public UserCollection users(List<UserCollectionItem> users) {
  ...
  **/
  ...
  public List<UserCollectionItem> getUsers() {
    return users;
  }


  public void setUsers(List<UserCollectionItem> users) {
    this.users = users;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.users, userCollection.users) &&
        Objects.equals(this.totalEntries, userCollection.totalEntries);
  }

  @Override
  public int hashCode() {
    return Objects.hash(users, totalEntries);
  }
