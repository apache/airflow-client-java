...
import com.apache.airflow.client.model.HealthInfo;
import com.apache.airflow.client.model.VersionInfo;
...
public class MonitoringApi {
     ...
     */
    public HealthInfo getHealth() throws ApiException {
        ApiResponse<HealthInfo> localVarResp = getHealthWithHttpInfo();
     ...
     */
    public ApiResponse<HealthInfo> getHealthWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getHealthValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<HealthInfo>(){}.getType();
     ...
     */
    public okhttp3.Call getHealthAsync(final ApiCallback<HealthInfo> _callback) throws ApiException {
    ...
    public VersionInfo getVersion() throws ApiException {
        ApiResponse<VersionInfo> localVarResp = getVersionWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call getVersionAsync(final ApiCallback<VersionInfo> _callback) throws ApiException {
