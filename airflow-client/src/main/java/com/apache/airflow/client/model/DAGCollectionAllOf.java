...
public class DAGCollectionAllOf {
  public static final String SERIALIZED_NAME_DAGS = "dags";
  @SerializedName(SERIALIZED_NAME_DAGS)
  private List<DAG> dags = null;


  public DAGCollectionAllOf dags(List<DAG> dags) {
    
    this.dags = dags;
    return this;
  }

  public DAGCollectionAllOf addDagsItem(DAG dagsItem) {
    if (this.dags == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DAGCollectionAllOf daGCollectionAllOf = (DAGCollectionAllOf) o;
    return Objects.equals(this.dags, daGCollectionAllOf.dags);
  }
  ...
  public String toString() {
    ...
    sb.append("class DAGCollectionAllOf {\n");
