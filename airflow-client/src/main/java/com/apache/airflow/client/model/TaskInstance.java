...
import com.apache.airflow.client.model.SLAMiss;
import com.apache.airflow.client.model.TaskState;
...
public class TaskInstance {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The DagRun ID for this task instance  *New in version 2.3.0* ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "*Changed in version 2.1.1*&#58; Field becomes nullable. ")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskId, dagId, dagRunId, executionDate, startDate, endDate, duration, state, tryNumber, maxTries, hostname, unixname, pool, poolSlots, queue, priorityWeight, operator, queuedWhen, pid, executorConfig, slaMiss);
  }
